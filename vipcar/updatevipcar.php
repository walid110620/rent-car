...
$sql="UPDATE vip SET  name_Car='$ncar' , matricul_Car='$matcar' , info_Car='$infocar' , prix_Car='$prixcar' , type='$type' , pict_Car='$imgcar' WHERE id='$id'";
      ...
      <div class="containerForm">
        <form action="#" method="POST">
            ...
            <select name="type" id="" class="box">
              <option value="<?php echo strip_tags($row['type']) ; ?>" disabled selected > auto / manuelle </option>
