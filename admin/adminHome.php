...
<html lang="en">
  <head>
    ...
    <script defer src="acceuilladmin.js"></script>
    <style>
...
.wrapbutton a.blue:hover{
    background: blue; color:white;
    transform:scale(1.1);
}
.wrapbutton a.red:hover{
    background: darkred; color:white;
    transform:scale(1.1);
}
.wrapbutton a.goldenrod:hover{
  ...
  <body id="home">
    ...
    <header class="header">
      ...
      <div class="login">
        ...
        ></a>
        <a href="admin.php" id="login">Admin</a>
      </div>
    </header>
      ...
      <div class="parentsec2 sec4">
        ...
        <div class="wrapperoffer">
          ...
          <div class="wrapbutton">
            <a class="blue" href="../vipcar/addcarsvip.php"> Add Car   </a>
            <a class="red" href="../vipcar/allcarsvip.php"> Delet Car </a>
            <a class="goldenrod" href="../vipcar/allcarsvip.php"> Update Car </a>
    ...
    <section id="section5">
      <div class="parentsec2 sec4">
        ...
        <div class="wrapperoffer">
          ...
          <div class="wrapbutton">
             <a class="blue" href="../CarsPhp/AddCar.php"> Add Car   </a>
           <a class="red" href="../CarsPhp/AllCars.php"> Delet Car </a>
           <a class="goldenrod" href="../CarsPhp/AllCars.php"> Update Car </a>
      ...
      <div class="wrapMaps">
       ...
       <span class="box-shadow-for-location"></span> 
        ...
        <div class="icons">
          ...
          <span class="whatsup flex">
            <i class="fa-brands fa-whatsapp ic"></i>
            <a class="margin what visi" href="">
                  <a id="contact" href="#contact" class=" margin visi">  +216 71 245 718  </a> 
