...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="../CarsPhp/allcars.css">
    <title>reservationCar</title>
...
<details class="goldenrod">
    ...
    <label><a href="../CarsPhp/AllCars.php"> All Cars </a>  </label>
        ...
        <table border="1" id="em">
            <caption>reservation cars</caption>
            <tr>
                <th>Name Car</th>
                <th>picture Car</th>
                <th>Delet</th>
...
<tr>
                ...
                <th class="th2">   <img src="../CarsPhp/imag/<?php echo strip_tags($row['pict_Car']); ?> " alt="" width="100px" height="100px">         </th>
