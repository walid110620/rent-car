...
$id=$_GET['update'];
$req="SELECT * FROM reserve WHERE idCR='$id'";
$res=@mysql_query($req);
...
$sql="UPDATE reserve SET days='$days' WHERE idCR='$id'";
...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="../CarsPhp/AddCar.css">
...
<details>
    ...
    <label><a href="/myproget/adminHome.php"> home  </a>  </label>
    <label><a href="/myproget/admin.php"> admin  </a>  </label>
  ...
  <div class="parenttitle">
      ...
      <div class="containerForm">
        ...
        <div>  <img src="../CarsPhp/imag/<?php echo strip_tags($row['pict_Car']); ?>" width="200px" height="200px" alt="">  </div>
