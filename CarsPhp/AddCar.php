...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['submit'])) {
        ...
        $nameFile="imag/".basename($_FILES['pict_Car']['name']);
        $imgcar = strip_tags($_FILES['pict_Car']['name']);

        $req = "INSERT INTO cars (name_Car,matricul_Car,info_Car,prix_Car,pict_Car,type)
        ...
        if ($res) {
          ...
          echo (" `<script> alert('add with succesfuly'); location.href='AllCars.php';   </script>`");
...
<div class="success"> php echo $message ; <br>
  <span> click </span>   <a href="AllCars.php" class="here"> here</a> <br> <span> to see your cars </span> </div>
